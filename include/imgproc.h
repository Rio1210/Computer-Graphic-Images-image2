...
class ImgProc
{
  ...
  public:
   ...
   ~ImgProc();
    ...
    void value_in(double x, double y, std::vector<float> &pixel) const;
...
/**************************************************************/
    ...
    void rms() ;
    void stat();
    void histogram(vector<vector<float>> &eq, vector<vector<float>> &CDF, vector<vector<float>> &PDF, vector<vector<float>> &his_pix);
